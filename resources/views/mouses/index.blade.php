...
<!-- <i class="fa-solid fa-computer-mouse" style="color: #000000;"><a href="{{ url('mouses/create') }}"></i> Registrar nuevo Mouse</a> -->
<button onclick="window.location.href = '{{ url('mouses/create') }}'">
<span class="box"><i class="fa-solid fa-computer" style="color: #0049ff;"> +
    Registrar nuevo mouse
    </span></i>
</button>
...
<table class="table table-sm">
    ...
    <tbody id="tabla-mouses">
        ...
        <!-- Editar -->
        <a href="{{ url('/mouses/'.$mouse->id.'/edit')}}" class="btn btn-warning m-2 editar"><i class="fa-solid fa-pen-to-square"></i> </a>

        <!-- Ver -->
        <a  href="mouses/{{$mouse->id}}"  class="btn btn-primary m-2 ver" style="color: #000000;" ><i class="fa-regular fa-eye"></i></a>

            @csrf
            {{ method_field('DELETE') }}
            <button type="button" class="btn btn-danger m-2 eliminar" style="color: #000000;" data-bs-toggle="modal" data-bs-target="#confirmDeleteModal{{ $mouse->id }}">
                            <i class="fa-regular fa-trash-can"></i>
                        </button>
                        <!-- Modal de confirmación de eliminación -->
                        <div class="modal fade" id="confirmDeleteModal{{ $mouse->id }}" tabindex="-1" aria-labelledby="confirmDeleteModalLabel" aria-hidden="true">
...
{{ $mouses->render('pagination::bootstrap-4') }}
</div>
...
function buscar() {
  ...
  table = document.getElementById("tabla-mouses");
