...
<body>
    <div class="container mt-5">
        ...
        <form action="{{ $modo == 'Crear' ? url('mouses') : url('mouses/' . $mouses->id) }}" method="POST">
            @csrf
            @if ($modo == 'Editar')
                @method('PUT')
            @endif
  ...
  <input type="text" name="serial_number" id="serial_number" class="form-control"
    value="{{ old('serial_number', isset($mouses->serial_number) ? $mouses->serial_number : '') }}">
  @error('serial_number')
    ...
    function generateSerialNumber() {
      ...
      $('#confirmModal').modal('hide');
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="model" id="model" value="{{ isset($mouses->model) ? $mouses->model : '' }}">
                @error('model')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="brand" id="brand" value="{{ isset($mouses->brand) ? $mouses->brand : '' }}">
                @error('brand')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="connection_type" id="connection_type" value="{{ isset($mouses->connection_type) ? $mouses->connection_type : '' }}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="status" id="status" value="{{ isset($mouses->status) ? $mouses->status : '' }}">
                @error('status')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="location" id="location" value="{{ isset($mouses->location) ? $mouses->location : '' }}">
                @error('location')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
            ...
            <a href="{{ url('mouses/') }}" class="btn btn-danger">Regresar</a>
        </form>
    </div>
