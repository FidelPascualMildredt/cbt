...
<label for="screen_type">Tipo de Pantalla</label>
<input type="text" name="screen_type" id="screen_type" value="{{ isset($monitors->screen_type) ? $monitors->screen_type : '' }}"><br>
...
<div class="container mt-5">
        ...
        <form action="{{ $modo == 'Crear' ? url('monitors') : url('monitors/' . $monitors->id) }}" method="POST">
            @csrf
            @if ($modo == 'Editar')
                @method('PUT')
            @endif
  ...
  <input type="text" name="serial_number" id="serial_number" class="form-control"
    value="{{ old('serial_number', isset($monitors->serial_number) ? $monitors->serial_number : '') }}">
  @error('serial_number')
      ...
      $('#confirmModal').modal('hide');
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="model" id="model"
                    value="{{ isset($monitors->model) ? $monitors->model : '' }}">
                @error('model')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="brand" id="brand"
                    value="{{ isset($monitors->brand) ? $monitors->brand : '' }}">
                @error('brand')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="connection_type" id="connection_type"
                    value="{{ isset($monitors->connection_type) ? $monitors->connection_type : '' }}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="status" id="status"
                    value="{{ isset($monitors->status) ? $monitors->status : '' }}">
                @error('status')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="screen_type" id="screen_type"
                    value="{{ isset($monitors->screen_type) ? $monitors->screen_type : '' }}">
                @error('screen_type')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="location" id="location"
                    value="{{ isset($monitors->location) ? $monitors->location : '' }}">
                @error('location')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
